                        ...
                        <div class="table-responsive w-100">
                            <table id="cardTable" class="table table-bordered  table-hover w-100">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center ">فئه البطاقه</th>
                                    <th class="text-center "> الشركه</th>
                                    <th class="text-center ">رمز البطاقه</th>
                                    <th class="text-center ">رمز البطاقه التسلسلي</th>
                                    <th class="text-center ">اسم المستلم</th>
    ...
    <script>
        $(document).ready(function () {
            $('#cardTable').DataTable({
                ...
                ajax: '{{route("log.datatable")}}',
                columns: [
                    {"data": 'id', "name": "id", orderable: true, searchable: true},
                    {"data": "user.user_name", 'name': "user.user_name", orderable: true, searchable: true},
                    {"data": "user.phone", 'name': "user.phone", orderable: true, searchable: true},
                    {"data": "card.sale_price", "name": "card.sale_price", orderable: true, searchable: true},
                    {"data": "type", "name": "type", orderable: true, searchable: true},
                    {"data": "card_amount", "name": "card_amount", orderable: true, searchable: true},
                    {"data": "company_name", "name": "company_name", orderable: true, searchable: true},
                    {"data": "key", "name": "key", orderable: true, searchable: true},
                    {"data": "card_id", "name": "card_id", orderable: true, searchable: true},
                    {"data": "transfer_to", "name": "transfer_to", orderable: true, searchable: true},
                    {"data": "transfer_to_phone", "name": "transfer_to_phone", orderable: true, searchable: true},

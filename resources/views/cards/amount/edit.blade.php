            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        @endif
                        <form action="{{route('amount.update',['amount'=>$amount->id])}}" method="post" enctype="multipart/form-data">
                            @method('PUT')

                            @csrf
                            <div class="form-group">
                                <label for="value" class="w-100 text-right">الاسم </label>
                                <input type="text" class="form-control" id="value" name="value" value="{{$amount->value}}">
                                @error('value')
